package pract.oop_java.pms.v1.configs;
...
import pract.oop_java.pms.v1.dto.responses.CustomAuthError;
import pract.oop_java.pms.v1.security.jwt.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .antMatchers(HttpMethod.POST,  "/api/v1/users/login" , "/api/v1/users/create","/api/v1/auth/login")
                .permitAll()
                .antMatchers(
                        "/v2/api-docs",
                        "/configuration/ui",
